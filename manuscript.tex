...
Table~\ref{tab:dis-by-genres} shows the probability of any genre experiencing a judgment of dislike for both the Prolific and Lucid samples, pooling the 2021 and 2023 Prolific samples.\footnote{The genres included in previous work that are not included in the present study are Big Band/Swing, Bluegrass, Folk, Gospel, Latin/Mariachi/Salsa, Mood/Easy Listening, and New Age/Space Music.} As we can see, Metal is the genre most likely to be disliked in both samples, consistent with previous work on Americans' musical tastes based on earlier data \citep{bryson1996anything-311, lizardo2015musical-8c6}. Both samples also agree that the two genres least likely to be disliked are Rock and Pop music. There is some disagreement across samples on the exact ranking of other genres. Country music experiences the most significant disparity, ranking second among the most disliked genres in the Prolific sample but near the bottom in the Lucid sample. Beyond that, both datasets agree that Musicals, Rap, and Disco are at the top of the dislike list, while Classical, R\&B, and Jazz are closer to the bottom. 
