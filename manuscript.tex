...
\begin{figure}[ht!]
    ...
    \label{fig:main}
\end{figure}
Figure~\ref{fig:main} shows the univariate distribution of the number of dislikes for the LM 2025 data. As we can see, the distribution exhibits excess zeroes, with about 20\% of the sample reporting zero dislikes among the twelve musical genres included. This figure is higher than the 15\% reported by \citet{lizardo2016end-4fb}, although we should be cautious when making direct comparisons, given that the number of genres included is lower in the LM 2025 marketplace survey. Nevertheless, we can at the very least conclude that categorical tolerance remains a pervasive phenomenon among a substantial number of Americans, and the taste regime governing patterns of cultural choice among Americans in the second decade of the twenty-first century certainly no longer resembles that captured by the GSS in the early 1990s. 
