...
```{r Wrangling Dislikes Data and Merging Demographics}
    ...
    save(dat.dis, dat.dis.23, dat.dis.25, file = here("cint-prolific-data1.rda"))
``` -->

# Descriptives

```{r Dislikes Data}
    load(here("cint-prolific-data1.rda"))
...
```{r Bivariate Plots}
     ...
     make.lolli.plot(make.plot.dat(dat.dis, Age, num.dis), a = 35, ref = r, high = 6, v = 1.75, h = 1)
