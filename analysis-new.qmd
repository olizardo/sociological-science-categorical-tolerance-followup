...
```{r Regression Analysis}
     m1 <- zeroinfl(
       num.dis ~  Age.n + Educ.n + Inc.n + polviews.n + White + Woman | Age.n, 
       data = dat.dis
       )
     m2 <- zeroinfl(
       num.dis ~  Age.n + Educ.n + Inc.n + polviews.n + White | Age.n + White + Woman, 
       data = dat.dis
       )
     m3 <- zeroinfl(
       num.dis ~  Age.n + Educ.n + Inc.n + polviews.n + White | Age.n + White + Woman +
     ...
     m4 <- zeroinfl(
       num.dis ~  Age.n + Educ.n + Inc.n + polviews.n + White | Age.n + White +  Woman +
         Educ.n + Educ2 + Inc.n + Inc2, 
       data = dat.dis
       )
     names(m1$coefficients$zero) <- c("Intercept", "Age")
     names(m2$coefficients$zero) <- c("Intercept", "Age", "White", "Woman")
